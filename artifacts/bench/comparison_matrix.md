...
|-----------|-----------|----------------------|-----------------|
| Setup friction (s) | 0.196 (score 100.0) | NOT MEASURED | architecture: local-first, single CLI |
| Blocker visibility (s) | 0.0018 (score 100.0) | NOT MEASURED | generic agents have no gate model |
...
- Tool: **1 command**.
- Manual baseline (conservative): **5x** more inspection units (median across 23 runs; range 3x–47x).
