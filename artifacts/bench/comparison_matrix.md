...
|-----------|-----------|----------------------|-----------------|
| Setup friction (s) | 0.136 (score 100.0) | NOT MEASURED | architecture: local-first, single CLI |
| Blocker visibility (s) | 0.0015 (score 100.0) | NOT MEASURED | generic agents have no gate model |
