...
Overall score (mean of measured): 86.9
...
|---|-----------|--------|-------|-------|--------|
| 1 | setup_friction | MEASURED | 0.137 | 100.0 | Cold `init` + first `plan` completed in 0.14s (target <300s). |
| 2 | blocker_visibility | MEASURED | 0.0019 | 100.0 | Computed readiness and located first blocking gate (intake_scope) for run 'audit-container-hard-isolation-20260525'. |
