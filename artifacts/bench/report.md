...
|---|-----------|--------|------|-------|-------|--------------|--------|
| 1 | setup_friction | MEASURED | CAPABILITY | 0.164 | 100.0 | no | Cold `init` + first `plan` completed in 0.16s (target <300s). |
| 2 | blocker_visibility | MEASURED | CORPUS | 0.0014 | 100.0 | yes | Computed readiness and located first blocking gate (intake_scope) for run 'add-oauth-login-with-audit-logging-20260615-101934'. |
| 3 | evidence_completeness | MEASURED | CORPUS | 85.4 | 85.4 | yes | 258/302 executed gates across 26 runs carry evidence. |
| 4 | hallucination_count | MEASURED | CORPUS | 0 | 100.0 | yes | Scanned 19 reports; 0 unsupported claim candidates. |
| 5 | redteam_independence | MEASURED | CONFIG | 100.0 | 100.0 | no | 20/20 HIGH/EXTREME runs assign a red-team worker distinct from the implementer. |
...
| 8 | release_readiness_accuracy | MEASURED | CONSISTENCY | 100.0 | 100.0 | no | 26/26 runs: release verdict is consistent with blocker presence. |
